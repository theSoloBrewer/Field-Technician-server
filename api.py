...
api.add_resource(Project, '/project', '/project/<string:project_code>')
...
api.add_resource(Materials,'/project/<string:project_code>/material/',
				 '/material/',
				 '/project/<string:project_code>/material/<int:mat_id>/',
				 '/material/<int:mat_id>/')
